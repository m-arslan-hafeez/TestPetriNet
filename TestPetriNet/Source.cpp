...
//	vector<int> vehiclesInPerRoute{ 71, 82, 38, 49 }; // Specific number of vehicles for each in-route
...
//		int delaySeconds;
//		if (vehiclesToMove > 70 && vehiclesToMove <= 100) {
//			delaySeconds = 50;
//		}
//		if (vehiclesToMove >= 50 && vehiclesToMove <= 70) {
//			delaySeconds = 38;
//		}
//		else if (vehiclesToMove < 50 && vehiclesToMove > 0) {
//			delaySeconds = 25;
//		}
//		else {
//			delaySeconds = 0; // No delay for other cases
//		}
//
//		// Delay for delaySeconds
//		if (delaySeconds > 0) {
//			cout << "Opening 'in' Route " << (routeWithMaxVehicles + 1) << " for " << delaySeconds << " seconds..." << endl;
...
//		routeTimes[routeWithMaxVehicles] += delaySeconds;
//
...
//		timeDataFile << priorityOrder << " " << routeWithMaxVehicles + 1 << " " << routeTimes[routeWithMaxVehicles] << endl;
